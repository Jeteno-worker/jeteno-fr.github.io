export class FrView {
    ...
    createMaskVideo() {
        ...
        const frameBackground = document.createElementNS('http://www.w3.org/2000/svg', 'svg');

        frame.setAttribute('viewBox', '0 0 386 524');
